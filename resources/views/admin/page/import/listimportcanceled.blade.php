...
@section('content')
	...
	<ol class="breadcrumb">
	  	...
	  	<li class="breadcrumb-item active">Canceled Import</li>
	</ol>
	@endsection
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-success">
				<div class="panel-heading">
					<span class="panel-title">List Canceled Imports</span>
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$import->status}}</td>
								<td>
									<span><a href="{{route('getimportdetail',[$import->id,0])}}" class="btn btn-warning">Detail</a></span>
									<span><a href="{{route('getactiveimport',$import->id)}}" class="btn btn-success">Active</a></span>
								</td>
